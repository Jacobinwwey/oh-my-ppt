...
- Do not create flickering or large-scale shaking animations`
  ...
  thinking: {
    ...
    homeDescription: 'Choose the creation path that fits the job: generate directly when the brief is clear, or explore first when the material needs shaping.',
    quickCreate: 'Quick Create',
    quickCreateDescription: 'Best when the topic, page count, and style are already clear. Fill in the basics and go straight to generation.',
    quickCreateBadge: 'Direct',
    quickCreatePointOne: 'Choose topic, pages, style, and fonts manually.',
    quickCreatePointTwo: 'Works best for clear tasks with prepared material.',
    startQuickCreate: 'Set generation options',
