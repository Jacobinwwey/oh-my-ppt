...
function buildSelectorEditPrompt(
  ...
  return [
    ...
    '- 支持 data-anim="fade | fade-up | fade-down | fade-left | fade-right | scale-in | slide-up | slide-left | lottie"。',
    '- 支持强调动效 data-anim="pulse | shake | bounce | glow"（装饰性弹性效果，可配合 data-anim-loop="true" 循环）。',
    '- 支持 data-anim-out="fade | fade-up | fade-down | fade-left | fade-right | scale-out | slide-up | slide-down | slide-left | slide-right" 退出动画。',
    '- 支持 data-anim-trigger="load | click"、data-anim-delay、data-anim-duration、data-anim-easing、data-anim-loop；click 是低优先级方案，只在用户表达点击/按键/逐步展示意图时使用。',
    '- lottie 类型额外支持 data-anim-lottie-src（JSON URL/路径）、data-anim-lottie-loop、data-anim-lottie-autoplay、data-anim-lottie-speed。',
